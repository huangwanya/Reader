	...
	<table class="tableborder" align="center" cellpadding="4"
		...
		<tbody>
			<tr class="header">
				...
				<td align="center" width="50%">兴趣标签名称</td>
				<td align="center">操作</td>
			</tr>
			<c:forEach var="tmp" items="${list_}"  varStatus="itemindex" >
						<tr>
							...
							<td class="altbg1" align="center">
								...
								<a target="mainFrame"
										href="${pageContext.request.contextPath}/type_edit.action?type.id=${tmp.id }">修改
									</a>
									<a target="mainFrame"
										href="${pageContext.request.contextPath}/type_delete.action?type.id=${tmp.id }">删除
									</a>
