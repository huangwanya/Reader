		...
		<tbody>
			...
			<!-- 
			 ...
			 -->
				...
				<td align="center" width="6%">角色</td>
				--><td align="center" width="6%">年级</td>
				<td align="center" width="6%">兴趣标签</td>
				<td align="center" width="12%">审核</td><!--
				
					<td align="center" width="6%">状态</td>
				
				--><td align="center">操作</td>
			</tr>
			<c:forEach var="tmp" items="${lst}" varStatus="itemindex">
						<tr>
							...
							<c:if test="${tmp.status ==0}">
									<a target="mainFrame"
										href="${pageContext.request.contextPath}/user_shenhe.action?user.id=${tmp.id }">认证</a>
							</c:if>
