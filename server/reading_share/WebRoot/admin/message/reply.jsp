...
<body leftmargin="0" rightmargin="0" topmargin="0"
	...
	<form action="message_reply.action" method="post" enctype="multipart/form-data">
		
		<input name="message.id" value="${message.id }" type="hidden" />

		<table class="tableborder" align="center" cellpadding="4"
			cellspacing="1" width="97%">
			<tbody>
				<tr>
					<td class="altbg1" width="20%">管理员答复</td>
					<td class="altbg2">	
						<textarea rows="4" cols="100" name="message.reply">${message.reply }</textarea>
						</td>
				</tr>
