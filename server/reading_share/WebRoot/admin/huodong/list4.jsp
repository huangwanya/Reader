	...
	<table class="tableborder" align="center" cellpadding="4"
		...
		<tbody>
			<tr class="header">
				...
				<td align="center" width="12%">反馈标题</td>
				<td align="center" width="10%">反馈人</td>
				<td align="center" width="8%">状态</td>
				<td align="center" width="8%">兴趣标签</td>
				<td align="center" width="8%">反馈费用</td>
				<td align="center" width="8%">反馈事由</td>
				<td align="center" width="10%">反馈资料</td>
						...
						<tr>
							...
							<td class="altbg1" align="center">	
								...
								<c:if test="${tmp.status2 ==1}">
										<font color="green">通过审批</font>
								</c:if>
							</td>
							<td class="altbg1" align="center">	${tmp.shetuan }</td>
							<td class="altbg1" align="center">	${tmp.huodong_date }</td>
							<td class="altbg1" align="center">	${tmp.huodong_addr }</td>
							<td class="altbg1" align="center">	
							...
							<td class="altbg1" align="center">
									...
									<a target="mainFrame"
										href="${pageContext.request.contextPath}/biotech_delete4.action?biotech.id=${tmp.id }">删除
									</a>
									
									<c:if test="${tmp.status2 ==0}">
									<a target="mainFrame"
										href="${pageContext.request.contextPath}/biotech_shenhe4.action?biotech.id=${tmp.id }">审批</a>
							</c:if>
