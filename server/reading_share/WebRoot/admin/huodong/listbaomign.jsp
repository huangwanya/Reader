	...
	<table class="tableborder" align="center" cellpadding="4"
		...
		<tbody>
			<tr class="header">
				...
				<td align="center" width="20%">报名用户</td>
				<td align="center" width="20%">报名时间</td>
				<td align="center">操作</td>
			</tr>
			<c:forEach var="tmp" items="${blist}" varStatus="itemindex">
						<tr>
							
							
							<td class="altbg1" align="center">	${itemindex.count}</td>
							<td class="altbg1" align="center">	${tmp.username }</td>
							<td class="altbg1" align="center">	${tmp.updatedate }</td>
