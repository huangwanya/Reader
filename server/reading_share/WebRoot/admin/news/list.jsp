	...
	<table class="tableborder" align="center" cellpadding="4"
		...
		<tbody>
			<tr class="header">
				...
				<td align="center" width="20%">通知公告标题</td>
			...
			<c:forEach var="tmp" items="${list}" varStatus="itemindex">
						<tr>
							...
							<td class="altbg1" align="center">	攻略</td>
							...
							<td class="altbg1" align="center">
								...
								<a target="mainFrame"
										href="${pageContext.request.contextPath}/biotech_editnews.action?biotech.id=${tmp.id }">修改
									</a>
									<a target="mainFrame"
										href="${pageContext.request.contextPath}/biotech_deletenews.action?biotech.id=${tmp.id }">删除
									</a>
