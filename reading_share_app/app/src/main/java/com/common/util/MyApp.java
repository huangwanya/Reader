...
public class MyApp extends Application {
    ...
    public static final String strKey = "13GGR5HKROhpVv6xaR3IjZO5oeGXD21c";
...
//		crashHandler.init(this);
	...
	public String getShetuanid() {
		String shetuanid = sysInitSharedPreferences.getString("shetuanid", "");
		return shetuanid;
	}



	public void setShetuanid(String shetuanid) {
		this.shetuanid = shetuanid;
		sysInitSharedPreferences.edit().putString("shetuanid", this.shetuanid).commit();
	}
	...
	public String getName() {
		String name = sysInitSharedPreferences.getString("name", "");
		return name;
	}
	...
	public String getAddress() {
		String address = sysInitSharedPreferences.getString("address", "");
		return address;
	}
	...
	public void setAddress(String address) {
		...
		sysInitSharedPreferences.edit().putString("address", this.address).commit();
	}



	public String getHours() {
		String hours = sysInitSharedPreferences.getString("hours", "");
		return hours;
	}
	...
	public void setHours(String hours) {
		this.hours = hours;
		sysInitSharedPreferences.edit().putString("hours", this.hours).commit();
	}
