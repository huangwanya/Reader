...
import com.common.util.ImageLoadTool;
...
public class MyTieziList extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		myApp = (MyApp) MyTieziList.this.getApplication();
	...
	/*	StrictMode.setThreadPolicy(new StrictMode.ThreadPolicy.Builder()
		...
		listView1.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, final int arg2,
					long arg3) {
				// TODO Auto-generated method stub
				new AlertDialog.Builder(MyTieziList.this).setTitle("提示")  
		        .setMessage("请根据提示进行操作").setNegativeButton("查看详情", new DialogInterface.OnClickListener() {  
		              
		            @Override  
		            public void onClick(DialogInterface dialog, int which) {  
		                // TODO Auto-generated method stub  
		            	Intent intent = new Intent(MyTieziList.this, InfoDetail.class);
	...
	add_new_xd.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(MyTieziList.this,AddTiezi.class);
				startActivity(intent);
	...
	public void addNew(View view) {
		Util.toIntent(MyTieziList.this, AddHuodong.class);
	}
	private Handler handler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			...
			if (msg.what == 0x127) {
				//
				Toast.makeText(MyTieziList.this, "操作成功",
		...
		new Thread() {
			public void run() {
				try {
					...
					String url = HttpUtil.URL_DUANZILISTUSER_ + "author="
							+ myApp.getLoginName();
	...
	private class GameAdapter extends BaseAdapter {
		...
		private GameAdapter() {
			inflater = LayoutInflater.from(MyTieziList.this);
		}
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			Glide.with(MyTieziList.this)
					.load(HttpUtil.URL_BASEUPLOAD + imagename)
					.into(holder.image_view);
			
//			new ImageLoadTool(holder.image_view).execute(HttpUtil.URL_BASEUPLOAD + imagename);
			return convertView;
		}
