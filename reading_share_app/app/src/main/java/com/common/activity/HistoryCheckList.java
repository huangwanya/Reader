...
public class HistoryCheckList extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		myApp = (MyApp) HistoryCheckList.this.getApplication();
		setContentView(R.layout.history_check_list);
		...
		new Thread() {
			public void run() {
				try {
					...
					String url = HttpUtil.URL_CHECKLIST+myApp.getLoginKey();
	...
	private class GameAdapter extends BaseAdapter {
		...
		private GameAdapter() {
			inflater = LayoutInflater.from(HistoryCheckList.this);
		}
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			holder.name
					.setText("浏览内容："+basemarkBeans.get(position).getTitle()+"\n作者："+basemarkBeans.get(position).getAuthor());
			holder.phone
			.setText("浏览时间:" + basemarkBeans.get(position).getUpdatedate());
		/*	holder.qq
